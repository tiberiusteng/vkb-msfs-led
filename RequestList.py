...
class AircraftRequests():
	...
	class __AircraftAutopilotData(RequestHelper):
		list = {
			...
			"AUTOPILOT_ALTITUDE_ARM": ["Altitude hold arm", b'AUTOPILOT ALTITUDE ARM', b'Bool', 'N'],
			"AUTOPILOT_ALTITUDE_LOCK": ["Altitude hold active", b'AUTOPILOT ALTITUDE LOCK', b'Bool', 'N'],
			...
			"AUTOPILOT_GLIDESLOPE_ARM": ["GS hold arm", b'AUTOPILOT GLIDESLOPE ARM', b'Bool', 'N'],
			"AUTOPILOT_GLIDESLOPE_ACTIVE": ["GS hold active", b'AUTOPILOT GLIDESLOPE ACTIVE', b'Bool', 'N'],
			...
			"AUTOPILOT_APPROACH_ARM": ["Approach mode armed", b'AUTOPILOT APPROACH ARM', b'Bool', 'N'],
			"AUTOPILOT_APPROACH_ACTIVE": ["Approach mode active", b'AUTOPILOT APPROACH ACTIVE', b'Bool', 'N'],
			"AUTOPILOT_APPROACH_CAPTURED": ["Approach mode captured", b'AUTOPILOT APPROACH CAPTURED', b'Bool', 'N'],
